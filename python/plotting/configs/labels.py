...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["tt_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mt_mt_2"] = "$\\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mt_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_pt_1"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{\\mu}) / \\mathrm{GeV}$"
			self.labels_dict["mt_pt_2"] = "$\\mathrm{p}_{\\mathrm{T}}(\\tau) / \\mathrm{GeV}$"
			...
			self.labels_dict["et_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}}(e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["et_mt_2"] = "$\\mathrm{m}_{\\mathrm{T}}(\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["et_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}}(e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["et_pt_1"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{e}) / \\mathrm{GeV}$"
			self.labels_dict["et_pt_2"] = "$\\mathrm{p}_{\\mathrm{T}}(\\tau) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["em_mt_2"] = "$\\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["em_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_pt_1"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{e}) / \\mathrm{GeV}$"
			self.labels_dict["em_pt_2"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{\\mu}) / \\mathrm{GeV}$"
			...
			self.labels_dict["mm_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mm_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["ee_mt_1"] = "$\\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["ee_mt_lep1met"] = "$\\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["ee_pt_1"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{e}) / \\mathrm{GeV}$"
			self.labels_dict["ee_pt_2"] = "$\\mathrm{p}_{\\mathrm{T}}(\\mathrm{\\mu}) / \\mathrm{GeV}$"
			...
			for ch in ["ee_", "em_", "et_", "mm_", "mt_", "tt_"]:
				...
				self.labels_dict[ch+"diLepDeltaR"] = "$\\Delta\\mathrm{R}(\\ell\\ell)$"
				self.labels_dict[ch+"diLepJet1DeltaR"] = "$\\Delta\\mathrm{R}(\\ell\\ell,\\mathrm{J}_1)$"
				self.labels_dict[ch+"diLep_diJet_deltaR"] = "$\\Delta\\mathrm{R}(\\ell\\ell,\\mathrm{JJ})$"
				self.labels_dict[ch+"H_pt"] = "$\\mathrm{p}_{\\mathrm{T}}(\\ell\\ell,\\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
